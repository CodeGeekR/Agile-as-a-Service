...
const translations = {
  es: {
    ...
    footer: {
      ...
      copyright: "© 2025 AaaS. Todos los derechos innecesariamente reservados."
    },
    // Auth Modal
    auth: {
    ...
    sprints: {
      ...
      subtitle: "Administra tus sprints de existencia optimizada",
      newSprint: "Nuevo Sprint",
      activeSprint: "Sprint Activo",
      history: "Historial de Sprints",
      allStatuses: "Todos los estados",
      active: "Activo",
      completed: "Completado",
      cancelled: "Cancelado",
      activeCount: "Sprints Activos",
      completedCount: "Completados",
      totalPoints: "Puntos Totales",
      velocity: "Velocity Promedio",
      noActiveSprint: "No hay sprint activo",
      createFirstSprint: "Crea tu primer sprint para comenzar a optimizar tu existencia",
      ...
      confirmComplete: "¿Estás seguro de que quieres completar este sprint?",
      noSprints: "No hay sprints",
      noSprintsDesc: "No se encontraron sprints con el filtro seleccionado",
    ...
    retrospectives: {
      ...
      subtitle: "Analiza y mejora tus sprints de existencia",
      newRetrospective: "Nueva Retrospective",
      totalRetros: "Retrospectives Realizadas",
      avgVelocity: "Velocity Promedio",
      trend: "Tendencia",
      currentSprint: "Sprint Actual",
      history: "Historial de Retrospectives",
      allSprints: "Todos los sprints",
      noRetros: "No hay retrospectives",
      noRetrosDesc: "Completa tu primer sprint para crear una retrospective",
      positives: "Positivos",
      improvements: "Mejoras",
      velocity: "Velocity",
      viewDetails: "Ver Detalles",
      startRetrospective: "Iniciar Retrospective",
      whatWentWell: "¿Qué salió bien?",
      whatWentWrong: "¿Qué se puede mejorar?",
      actionItems: "Acciones para el próximo sprint",
      overallMood: "Estado de ánimo general",
      sprintVelocity: "Velocity del Sprint",
      createRetrospective: "Crear Retrospective",
      mood: {
        excellent: "Excelente",
        good: "Bueno",
        neutral: "Neutral",
  ...
  en: {
    ...
    footer: {
      ...
      copyright: "© 2025 AaaS. All rights unnecessarily reserved."
    },
    // Auth Modal
    auth: {
      login: "Sign In",
    ...
    sprints: {
      ...
      subtitle: "Manage your optimized existence sprints",
      ...
      completed: "Completed",
      cancelled: "Cancelled",
      activeCount: "Active Sprints",
      completedCount: "Completed",
      totalPoints: "Total Points",
      velocity: "Average Velocity",
      noActiveSprint: "No active sprint",
      createFirstSprint: "Create your first sprint to start optimizing your existence",
      ...
      confirmComplete: "Are you sure you want to complete this sprint?",
      noSprints: "No sprints",
      noSprintsDesc: "No sprints found with the selected filter",
    ...
    retrospectives: {
      title: "Retrospectives",
      subtitle: "Analyze and improve your existence sprints",
      newRetrospective: "New Retrospective",
      totalRetros: "Retrospectives Completed",
      avgVelocity: "Average Velocity",
      trend: "Trend",
      currentSprint: "Current Sprint",
      history: "Retrospectives History",
      allSprints: "All sprints",
      noRetros: "No retrospectives",
      noRetrosDesc: "Complete your first sprint to create a retrospective",
      positives: "Positives",
      improvements: "Improvements",
      velocity: "Velocity",
      viewDetails: "View Details",
      startRetrospective: "Start Retrospective",
      whatWentWell: "What went well?",
      whatWentWrong: "What can be improved?",
      actionItems: "Actions for next sprint",
